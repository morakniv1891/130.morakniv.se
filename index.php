    ...
    function countdown(){
      ...
      if(seconds <= 0 || minutes <= 0 || hours <= 0 || days <= 0) {
        ...
        for (i = 0; i < elements.length; i++) {
          elements[i].innerHTML = '<a href="https://morakniv.se/en/products/" class="buy-now-button">Shop now <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Pro 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M352 128C352 57.421 294.579 0 224 0 153.42 0 96 57.421 96 128H0v304c0 44.183 35.817 80 80 80h288c44.183 0 80-35.817 80-80V128h-96zM224 32c52.935 0 96 43.065 96 96H128c0-52.935 43.065-96 96-96zm192 400c0 26.467-21.533 48-48 48H80c-26.467 0-48-21.533-48-48V160h64v48c0 8.837 7.164 16 16 16s16-7.163 16-16v-48h192v48c0 8.837 7.163 16 16 16s16-7.163 16-16v-48h64v272z"/></svg></a>';
        }
        timeExpired = true;
      }
    ...
    <section class="page-3">
      ...
      <div class="second-content-wrapper">
        <div class="text-wrapper">
          ...
          <p class="text"><pre>The knife was actually, despite its name, launched as early as 1991. Since then, it has become a true classic amongst knife users around the world. When the knife was launched nearly a decade before the great imminent millennium, it was given the futuristic name Mora 2000. 30 years have now passed and the Anniversary Edition is our tribute to the original knife.</pre></p>
        </div>
        <picture>
