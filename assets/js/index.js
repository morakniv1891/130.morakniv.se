...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("call", function (t, e, i) {
    if (t === "menuappear" && e === "enter") {
      (0, _jquery.default)("#menu-bar").css("display", "flex");
      (0, _jquery.default)("#menu-bar").css("top", "0");
      (0, _jquery.default)("#menu-bar").hide();
      (0, _jquery.default)("#menu-bar").fadeIn(3000);
      var scrolltoexplore = (0, _jquery.default)("#scroll-to-explore-text");
      ...
      var target = document.getElementById("page-1");
