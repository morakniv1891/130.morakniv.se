...
(0, _jquery.default)(document).ready(function () {
  ...
  (0, _jquery.default)(window).scrollTop(0); // $("section.top-hero").on("animationstart webkitAnimationStart oAnimationStart", function () {
