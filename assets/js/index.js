...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    (0, _jquery.default)(".page-2[data-scroll-section-inview] ~ .page-2__knife-image").css("top", 1 - scrollY / (vh / 2.5));
