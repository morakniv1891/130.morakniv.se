...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    console.log((0, _jquery.default)(".page-1[data-scroll-section-inview]"));
    console.log(vh);
