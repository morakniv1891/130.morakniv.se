...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    (0, _jquery.default)(".scroll-to-explore").css("opacity", 1 - scrollY / (vh / 3)); // console.log(vh);
    // console.log(scrollY);
    // console.log(o);
  });
