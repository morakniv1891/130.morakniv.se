  ...
  scroll.on("scroll", function (o) {
    if (o.direction === "up") {
      ...
      (0, _jquery.default)(".top-hero__container .left").css({
        "-webkit-transform": "translateY(" + (0, _jquery.default)("body").scrollTop() + ")",
        "-moz-transform": "translateY(" + (0, _jquery.default)("body").scrollTop() + ")",
        "-ms-transform": "translateY(" + (0, _jquery.default)("body").scrollTop() + ")",
        "-o-transform": "translateY(" + (0, _jquery.default)("body").scrollTop() + ")",
        transform: "translateY(" + (0, _jquery.default)("body").scrollTop() + ")"
      });
    }
  });
