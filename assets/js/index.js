    ...
    switch (t) {
      case "menu-entry":
        if (e === "exit") {
          (0, _jquery.default)("header").css("top", "0");
          menuActive = true;
          (0, _jquery.default)(".page-2__content img").animate({
            top: "50%"
          }, 3000);
        }
