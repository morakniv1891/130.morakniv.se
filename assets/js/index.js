...
(0, _jquery.default)(document).ready(function () {
  ...
  var viewportHeight = (0, _jquery.default)(window).height();
  setTimeout(function () {
    (0, _jquery.default)("html, body").animate({
      scrollTop: viewportHeight * 2
    }, 3000, function () {
      (0, _jquery.default)("section.top-hero").css("background-image", "none");
      (0, _jquery.default)("section.top-hero").height("100vh");
    });
  }, 1500);
});
