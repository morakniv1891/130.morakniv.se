...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    (0, _jquery.default)(".page-1[data-scroll-section-inview] .middle img").css("opacity", scrollY / vh);
    console.log(vh);
