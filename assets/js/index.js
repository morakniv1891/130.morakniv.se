  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-2[data-scroll-section-inview]")) {
      if (scrollY > vh) {
        ...
        (0, _jquery.default)(".page-2__knife-image").css("top", (1 - scrollY / vh) * 100 + 10 + 40 * (scrollY / vh) + "%");
      }
    }
