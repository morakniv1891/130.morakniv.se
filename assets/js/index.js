...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-1[data-scroll-section-inview]").length && scrollY <= vh) {
      (0, _jquery.default)(".page-2__knife-image").css("top", 115 - 65 * (scrollY / vh) + "%");
