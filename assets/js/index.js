...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("call", function (t, e, i) {
    if (t === "menuappear" && e === "enter") {// $("#menu-bar").css("display", "flex");
      // $("#menu-bar").css("top", "0");
      // $("#menu-bar").hide();
