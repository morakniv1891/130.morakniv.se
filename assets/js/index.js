...
(0, _jquery.default)(document).ready(function () {
  (0, _jquery.default)(window).on("beforeunload", function () {// $("main").remove();
    // $(window).scrollTop(0);
  }); // $(window).scrollTop(0);
