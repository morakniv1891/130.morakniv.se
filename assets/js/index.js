  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-2[data-scroll-section-inview]")) {
      if (scrollY >= vh * 2) {
        ...
        var movement = scrollY / (vh * 2) !== 0 ? 1 / (scrollY / (vh * 2)) : 5000;
        (0, _jquery.default)(".page-2__knife-image").css("top", 100 - 1 / movement * 100 + 1 / movement * 50 + "%");
        console.log(1 / movement * 100);
        console.log(1 / movement * 50);
        console.log(1 / movement * 100 + 1 / movement * 50); // console.log(150 - (scrollY / (vh * 2)) * 100);
      }
    }
