...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    if (o.direction === "up") {
      ...
      console.log(window.scrollY); // let heroContainer = $(".top-hero__container");
