...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    if (scrollY > vh / 3 && (0, _jquery.default)(".page-2__knife-image").css("top") < "50%") {
      ...
      console.log((0, _jquery.default)(".page-2__knife-image").css("top") / o.limit);
    }
