...
(0, _jquery.default)(document).ready(function () {
  var vh = Math.max(document.documentElement.clientHeight || 0, window.innerHeight || 0); // document.documentElement.style.setProperty("--vh", `${vh * 0.01}px`);
