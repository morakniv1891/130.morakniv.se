...
(0, _jquery.default)(document).ready(function () {
  ...
  (0, _jquery.default)(window).on("touchmove", function (e) {
    e.preventDefault();
    console.log(e);
  }); // $(window).scrollTop(0);
