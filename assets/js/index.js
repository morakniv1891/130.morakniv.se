...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    if (o.direction === "up") {
      ...
      console.log((0, _jquery.default)("main").scrollTop()); // let heroContainer = $(".top-hero__container");
