...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    if (o.direction === "up") {
      ...
      (0, _jquery.default)(".top-hero__container .left").css({
        "-webkit-transform": "translateY(" + (0, _jquery.default)(document).scrollTop() + ")",
        "-moz-transform": "translateY(" + (0, _jquery.default)(document).scrollTop() + ")",
        "-ms-transform": "translateY(" + (0, _jquery.default)(document).scrollTop() + ")",
        "-o-transform": "translateY(" + (0, _jquery.default)(document).scrollTop() + ")",
        transform: "translateY(" + (0, _jquery.default)(document).scrollTop() + ")"
      });
    }
  });
  scroll.on("call", function (t, e, i) {
    if (t === "menuappear" && e === "enter") {
      (0, _jquery.default)(".scroll-to-explore-text").fadeOut(2000); // $("#menu-bar").css("display", "flex");
      // $("#menu-bar").css("top", "0");
      // $("#menu-bar").hide();
