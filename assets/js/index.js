...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-2[data-scroll-section-inview]").length && scrollY <= vh) {
      ...
      (0, _jquery.default)(".page-2__knife-image").css("top", 200 - 150 * Math.cbrt(f) + "%");
