...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    if (o.direction === "up") {
      ...
      var heroContainer = (0, _jquery.default)(".top-hero__container");
