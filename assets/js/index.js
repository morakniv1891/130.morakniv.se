...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    y += 1;
    (0, _jquery.default)(".page-2__knife-image").css("transform", "translateY(".concat(y, ")"));
