...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".knife-in-view.is-inview").length) {
      console.log("inview");
      (0, _jquery.default)(".page-2__knife-image").animate({
        top: "50%"
      }, 2000);
