...
(0, _jquery.default)(document).ready(function () {
  ...
  var viewportHeight = (0, _jquery.default)(window).height(); // setTimeout(function () {
  //   $("html, body").animate(
  //     {
