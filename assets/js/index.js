...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-1[data-scroll-section-inview]").length && knifeOffset <= 57.5) {
      knifeOffset += o.speed / 10;
      (0, _jquery.default)(".page-2__knife-image").css("top", 115 - knifeOffset + "%");
    } else {
      (0, _jquery.default)(".page-2__knife-image").css("top", "57.5%");
      knifeOffset = 57.5;
