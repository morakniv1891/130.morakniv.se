...
(0, _jquery.default)(document).ready(function () {
  ...
  setTimeout(function () {
    (0, _jquery.default)("html, body").animate({
      ...
      (0, _jquery.default)("section.top-hero").remove();
    });
  }, 1500);
});
