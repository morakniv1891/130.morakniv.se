  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-2[data-scroll-section-inview]")) {
      if (scrollY > vh) {
        ...
        (0, _jquery.default)(".page-2__knife-image").css("top", (1 - scrollY / (vh / (2 * (1 - scrollY / vh)))) * 100 + 50 + "%");
        console.log(vh / (2 * (1 - scrollY / vh)));
      }
    }
