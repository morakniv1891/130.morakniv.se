...
(0, _jquery.default)(document).ready(function () {
  ...
  (0, _jquery.default)(window).on("scroll", function (e) {
    e.preventDefault();
    console.log((0, _jquery.default)("main").scrollTop());
  }); // $(window).scrollTop(0);
