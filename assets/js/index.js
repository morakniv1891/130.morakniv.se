  ...
  setTimeout(function () {
    (0, _jquery.default)("html, body").animate({
      ...
      complete: function complete() {
        (0, _jquery.default)("section.top-hero").height(window.height());
      }
    }, 3000);
  }, 1500);
});
