...
(0, _jquery.default)(document).ready(function () {
  ...
  scroll.on("scroll", function (o) {
    ...
    (0, _jquery.default)(".page-1[data-scroll-section-inview] .bottom-line .left").css("opacity", 1 - scrollY / (vh / 1.5));
    console.log(vh);
    console.log(1 - scrollY / (vh / 2)); // console.log(o);
  });
