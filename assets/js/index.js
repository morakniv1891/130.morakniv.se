...
(0, _jquery.default)(document).ready(function () {
  ...
  (0, _jquery.default)(window).on("beforeunload", function () {
    (0, _jquery.default)("main").remove();
  });
  scroll.on("scroll", function (o) {
    var vh = Math.max(document.documentElement.clientHeight || 0, window.innerHeight || 0);
    var scrollY = o.scroll.y; //First page movements

    if ((0, _jquery.default)(".page-1[data-scroll-section-inview]")) {
      (0, _jquery.default)(".page-1[data-scroll-section-inview] .middle img").css("opacity", 1 - scrollY / (vh / 2.5));
      (0, _jquery.default)(".page-1[data-scroll-section-inview] .middle img").css("transform", "scale(0.5)");
      (0, _jquery.default)(".page-1[data-scroll-section-inview] .top-line .left").css("opacity", 1 - scrollY / (vh / 3));
      (0, _jquery.default)(".page-1[data-scroll-section-inview] .bottom-line .left").css("opacity", 1 - scrollY / (vh / 2));
    }

    (0, _jquery.default)(".scroll-to-explore").css("opacity", 1 - scrollY / (vh / 3)); //Second page movements

    if ((0, _jquery.default)(".page-2[data-scroll-section-inview]")) {
      if (scrollY >= vh) {
        (0, _jquery.default)(".page-2__knife-image").css("top", "50%");
      } else {
        var moveFactor = scrollY / vh !== 0 ? 1 - 1 / (1 / (scrollY / vh)) : 1;
        var move = scrollY / vh * 100;
        (0, _jquery.default)(".page-2__knife-image").css("top", 150 - move * moveFactor + "%");
        console.log(move * moveFactor);
        console.log(moveFactor); // console.log((1 / movement) * 50);
    ...
    if (menuActive) {
      (0, _jquery.default)("header").css("top", "0");
    }

    if (o.direction === "down" && menuHide) {
      (0, _jquery.default)("header").css("top", "-80px");
    }
