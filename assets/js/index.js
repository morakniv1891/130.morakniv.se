  ...
  scroll.on("scroll", function (o) {
    ...
    if ((0, _jquery.default)(".page-2[data-scroll-section-inview]")) {
      if (scrollY >= vh * 2) {
        ...
        console.log(scrollY / (vh * 2) !== 0 ? 1 / (scrollY / (vh * 2)) : 0); // console.log(150 - (scrollY / (vh * 2)) * 100);
      }
    }
