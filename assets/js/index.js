  ...
  setTimeout(function () {
    (0, _jquery.default)("html, body").animate({
      ...
      complete: function complete() {
        console.log((0, _jquery.default)("section.top-hero").height());
      }
    }, 3000);
  }, 1500);
});
